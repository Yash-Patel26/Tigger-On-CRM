...
class _HomeScreenState extends State<HomeScreen> {
  ...
  final String _profileImageUrl = 'https://i.pravatar.cc/150?img=3';
            ...
            child: Row(
              ...
              children: <Widget>[
                _CircularLottieButton(
                  lottieUrl: 'assets/lottie files/lead.json',
                  label: 'Lead',
                  onTap: () {
                    Navigator.of(context).push(
                      SmoothPageTransitions.slideFromRight<void>(
                ...
                _CircularLottieButton(
                  lottieUrl: 'assets/lottie files/site_visit.json',
                  label: 'Site Visit',
                  onTap: () {
                    Navigator.of(context).push(
                      SmoothPageTransitions.slideFromRight<void>(
                ...
                _CircularLottieButton(
                  lottieUrl: 'assets/lottie files/booking.json',
                  label: 'Booking',
                  onTap: () {
                    Navigator.of(context).push(
                      SmoothPageTransitions.slideFromRight<void>(
                ...
                _CircularLottieButton(
                  lottieUrl: 'assets/lottie files/Dashboard.json',
                  label: 'Dashboard',
                  onTap: () {
                    Navigator.of(context).push(
                      SmoothPageTransitions.slideFromRight<void>(
