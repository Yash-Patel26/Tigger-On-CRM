...
class CallService {
  static supabase.SupabaseClient get _client => supabase.Supabase.instance.client;
  ...
  static Future<String> logCall({
    ...
    try {
      final dynamic res = await _client.rpc('log_call', params: <String, dynamic>{
        '_phone': phone,
  ...
  static Future<void> endCallWithRecording({
    ...
    try {
      await _client.rpc('end_call_with_recording', params: <String, dynamic>{
        '_call_id': callId,
        '_status': status,
